...
perl $BASEDIR/get_dis.pl $DB $HOST $USER $PSW > $BASEDIR/tmp/des
...
cp $BASEDIR/tmp/chunks/all $BASEDIR/tmp/tmp_omim_mmtx_0
...
perl $BASEDIR/omim.pl $BASEDIR/tmp/tmp_omim_mmtx_1 >$BASEDIR/tmp/MetaMap_omim2do_raw
